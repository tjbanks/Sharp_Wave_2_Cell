...
#define nrn_init _nrn_init__Pyr_ITN
#define _nrn_initial _nrn_initial__Pyr_ITN
#define nrn_cur _nrn_cur__Pyr_ITN
#define _nrn_current _nrn_current__Pyr_ITN
#define nrn_jacob _nrn_jacob__Pyr_ITN
#define nrn_state _nrn_state__Pyr_ITN
#define _net_receive _net_receive__Pyr_ITN 
#define release release__Pyr_ITN 
...
#define eta eta_Pyr_ITN
#define omega omega_Pyr_ITN
#define sfunc sfunc_Pyr_ITN
#define unirand unirand_Pyr_ITN
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Pyr_ITN C:/Users/Tyler/Desktop/git_stage/Sharp_Wave_BLA/Scripts_NEURON/12CellModel/Pyr_ITN.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 141 in file Pyr_ITN.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
