...
#define nrn_init _nrn_init__ITN_Pyr
#define _nrn_initial _nrn_initial__ITN_Pyr
#define nrn_cur _nrn_cur__ITN_Pyr
#define _nrn_current _nrn_current__ITN_Pyr
#define nrn_jacob _nrn_jacob__ITN_Pyr
#define nrn_state _nrn_state__ITN_Pyr
#define _net_receive _net_receive__ITN_Pyr 
#define release release__ITN_Pyr 
...
#define GAP1 GAP1_ITN_Pyr
#define eta eta_ITN_Pyr
#define omega omega_ITN_Pyr
#define unirand unirand_ITN_Pyr
...
#define GAPstop1 GAPstop1_ITN_Pyr
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_ITN_Pyr
...
#define k k_ITN_Pyr
 ...
 "k_ITN_Pyr", &k_ITN_Pyr,
 "GAPstart1_ITN_Pyr", &GAPstart1_ITN_Pyr,
 "GAPstop1_ITN_Pyr", &GAPstop1_ITN_Pyr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ITN_Pyr C:/Users/Tyler/Desktop/git_stage/Sharp_Wave_BLA/Scripts_NEURON/12CellModel/ITN_Pyr.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 136 in file ITN_Pyr.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
