...
#define GAP1 GAP1_Chn_Pyr
#define eta eta_Chn_Pyr
#define omega omega_Chn_Pyr
#define unirand unirand_Chn_Pyr
...
#define GAPstop1 GAPstop1_Chn_Pyr
 double GAPstop1 = 196000;
#define GAPstart1 GAPstart1_Chn_Pyr
...
#define k k_Chn_Pyr
 ...
 "k_Chn_Pyr", &k_Chn_Pyr,
 "GAPstart1_Chn_Pyr", &GAPstart1_Chn_Pyr,
 "GAPstop1_Chn_Pyr", &GAPstop1_Chn_Pyr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Chn_Pyr /storage/hpc/data/latimerb/Sharp_Wave_BLA/Scripts_NEURON/12CellModel/x86_64/Chn_Pyr.mod\n");
